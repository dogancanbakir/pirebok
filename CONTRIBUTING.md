...
pirebok could always use more documentation, whether as part of the
official pirebok docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
Ready to contribute? Here's how to set up `pirebok` for local development.

1. Fork the `pirebok` repo on GitHub.
